...
The hero eyebrow names the product and its auto-zoom feature. The lower strip lists the actual record, auto-zoom, edit and export workflow. The handwritten note over the demo is removed.
